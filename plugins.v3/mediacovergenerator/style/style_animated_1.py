    ...
    try:
        ...
        with tempfile.TemporaryDirectory() as tmp_dir:
            ...
            for f in range(total_frames):
                ...
                local = cycle_pos - cycle_index

                idx_a = cycle_index % n_cards
                idx_b = (cycle_index + 1) % n_cards
                idx_c = (cycle_index + 2) % n_cards
                idx_d = (cycle_index + 3) % n_cards
